        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/40 text-xs mt-0.5">ตอบคำถามหาคำตอบโรงแรมแมวจริงใจ</p>
            </div>
          </div>
